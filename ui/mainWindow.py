...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.itemList.setGeometry(QtCore.QRect(0, 0, 1087, 434))
        ...
        self.cost4 = QtWidgets.QLabel(parent=self.widget_3)
        self.cost4.setText("")
        self.cost4.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.cost4.setObjectName("cost4")
        self.horizontalLayout_3.addWidget(self.cost4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Tank"))
